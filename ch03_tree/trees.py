...
# Subset according to different values of a feature
...
def majorityCnt(classList):
	...
	sortedClassCount = sorted(classCount.irteritems(), key = operator.itemgetter(1) , reverse = Ture)
...
def createTree(dataSet,labels):
	...
	del(labels[bestFeat]) # delete labels[bestFeat] from labels
